---
type: Web Page
title: Technical FAQ | Backstage Software Catalog and Developer Platform
description: General technical questions about Backstage.
resource: https://backstage.io/docs/faq/technical
...
Backstage is a large scale TypeScript framework whose frontend parts use React and Material UI, while the backend parts use Node.js and the Express framework.
...
Yes, there are several commercial partners that offer hosted versions, enterprise support, and consulting services around Backstage.
...
1. Source page: https://backstage.io/docs/faq/technical
