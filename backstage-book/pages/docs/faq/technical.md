...
Learn more about [the different components](/docs/overview/what-is-backstage) that
make up Backstage.
...
[Phase 2](/docs/overview/roadmap) of the project we will add features that are
