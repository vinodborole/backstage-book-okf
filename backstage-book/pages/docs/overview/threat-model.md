...
resource: https://backstage.io/docs/overview/threat-model
...
[backend system](/docs/backend-system/) and at least Backstage release [version 1.24](/docs/releases/v1.24.0). Before that Backstage did not come with built-in protection against unauthorized access and you were required to deploy it in a protected environment.
...
Users that are signed in to Backstage generally have full access to all information and actions. If more fine-grained control is required, the [permissions system](/docs/permissions/overview) should be enabled and configured to restrict access as necessary.
...
1. Source page: https://backstage.io/docs/overview/threat-model
