---
type: Web Page
title: The Backend System | Backstage Software Catalog and Developer Platform
description: Introduction to Backstage's backend system and its documentation
resource: https://backstage.io/docs/backend-system
...
[Architecture](/docs/backend-system/architecture/index)
...
[Building Backends](/docs/backend-system/building-backends/index)
...
[Building Plugins and Modules](/docs/backend-system/building-plugins-and-modules/index)
...
[Core Services](/docs/backend-system/core-services/index)
...
1. Source page: https://backstage.io/docs/backend-system
