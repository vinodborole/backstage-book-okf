...
** backend.database.plugin.<pluginId>**. As an example, 
...
configurations below.### Minimal In-Memory Configuration
...
1. Source page: https://backstage.io/docs/tutorials/configuring-plugin-databases
