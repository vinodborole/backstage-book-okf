---
type: Web Page
title: Contributing New Provider Modules | Backstage Software Catalog and Developer
  Platform
description: Documentation on adding new authentication providers
resource: https://backstage.io/docs/auth/add-auth-provider
...
1. Source page: https://backstage.io/docs/auth/add-auth-provider
