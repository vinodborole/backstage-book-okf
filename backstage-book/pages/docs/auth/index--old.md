...
resource: https://backstage.io/docs/auth/index--old
timestamp: '2026-08-03T09:44:12.848210+00:00'
---

# Authentication in Backstage

This documentation is written for the old frontend system. If you are on the [new frontend system](/docs/frontend-system/) you may want to read [its own article](/docs/auth/) instead.
...
on how to configure the backend app, see [Sign-in Identities and Resolvers](/docs/auth/identity-resolver).
...
[Azure EasyAuth](/docs/auth/microsoft/easy-auth),
[Cloudflare Access](/docs/auth/cloudflare/provider),
[Google Identity-Aware Proxy](/docs/auth/google/gcp-iap-auth)
and [OAuth2 Proxy](/docs/auth/oauth2-proxy/provider).
...
```
In case you are using a custom authentication providers, you might need to add a [custom `ScmAuthApi` implementation](/docs/auth/#custom-scmauthapi-implementation).
...
through [Utility APIs](/docs/api/utility-apis) for each service provider. These
...
[Add authentication provider](/docs/auth/add-auth-provider) for details on adding a new
...
1. Source page: https://backstage.io/docs/auth/index--old
