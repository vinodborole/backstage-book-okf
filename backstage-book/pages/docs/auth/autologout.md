---
type: Web Page
title: Auto Logout | Backstage Software Catalog and Developer Platform
description: This section describes how to setup the Auto Logout mechanism in Backstage
resource: https://backstage.io/docs/auth/autologout
...
*Inactive users* are the ones that don't perform any action on the Backstage app or that are logged in but no Backstage tab is open in the browser.
...
1. Source page: https://backstage.io/docs/auth/autologout
