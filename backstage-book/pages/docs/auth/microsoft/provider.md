---
type: Web Page
title: Microsoft Azure Authentication Provider | Backstage Software Catalog and Developer
  Platform
description: Adding Microsoft Azure as an authentication provider in Backstage
resource: https://backstage.io/docs/auth/microsoft/provider
...
If these resolvers do not fit your needs you can build a custom resolver, this is covered in the [Building Custom Resolvers](/docs/auth/identity-resolver#building-custom-resolvers) section of the Sign-in Identities and Resolvers documentation.
...
[Adding the provider to the sign-in page](/docs/auth/#sign-in-configuration).

# Citations

1. Source page: https://backstage.io/docs/auth/microsoft/provider
