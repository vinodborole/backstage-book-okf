---
type: Web Page
title: Logging into Backstage | Backstage Software Catalog and Developer Platform
description: Getting up and running with Backstage and your identity provider
resource: https://backstage.io/docs/getting-started/logging-in
...
You should have already [have a standalone app](/docs/getting-started/) and completed the GitHub OAuth app setup defined in [the authentication tutorial](/docs/getting-started/config/authentication).
...
To login, you should choose the "GitHub" provider and click the "Sign in" button. This will redirect you to a GitHub OAuth page. Verify that the scopes mentioned on that page match the setup you did in [the authentication tutorial](/docs/getting-started/config/authentication). Once you click "Confirm", you will be brought back to the Backstage interface and signed in!
...
If you don't see your profile picture and name, check that you followed all of the steps in [the authentication tutorial](/docs/getting-started/config/authentication). If you have, search for similar issues on [the Discord server](https://discord.gg/backstage-687207715902193673).

# Citations

1. Source page: https://backstage.io/docs/getting-started/logging-in
