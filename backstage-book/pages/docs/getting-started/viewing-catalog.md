...
- `Type` - common types are as follows, but you can[create a new type](/docs/features/software-catalog/extending-the-model#adding-a-new-type-of-an-existing-kind) to meet your organization's needs
  - `service` - a backend service, typically exposing an API
  - `website` - a website
  - `library` - a software library, such as an npm module or a Java library
- `Lifecycle`  - `experimental` - an experiment or early, non-production component, signaling
