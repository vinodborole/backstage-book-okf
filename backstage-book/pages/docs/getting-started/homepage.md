...
```
Once installed, the plugin is automatically available in your app through the default feature discovery. For more details and alternative installation methods, see [installing plugins](/docs/frontend-system/building-apps/installing-plugins).
