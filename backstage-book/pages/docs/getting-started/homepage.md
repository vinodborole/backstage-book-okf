---
type: Web Page
title: Backstage homepage - Setup and Customization | Backstage Software Catalog and
  Developer Platform
...
read the [old frontend system version of this guide](/docs/getting-started/homepage--old)
instead.
...
[`@backstage/create-app`](/docs/getting-started/#creating-and-running-a-backstage-application) and not using a fork of the[backstage](https://github.com/backstage/backstage) repository.
...
discovery. See
[installing plugins](/docs/frontend-system/building-apps/installing-plugins)
...
1. Source page: https://backstage.io/docs/getting-started/homepage
