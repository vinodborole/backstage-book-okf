...
This page answers frequently asked questions about [TechDocs](/docs/features/techdocs/).
...
- [What should be the value of](#what-should-be-the-value-of-backstageiotechdocs-ref-when-using-external-build-and-storage)- `backstage.io/techdocs-ref`when using external build and storage?
...
The value of
[ backstage.io/techdocs-ref](/docs/features/software-catalog/well-known-annotations#backstageiotechdocs-ref)
metadata annotation is used in the build process of TechDocs. But when

[is set to](/docs/features/techdocs/configuration)

`techdocs.builder``'external'` in
...
entity.#### What happens when you navigate to a TechDocs URL for an entity uses the `backstage.io/techdocs-entity` annotation?
