...
```
[Template Entity](/docs/features/software-catalog/descriptor-format#kind-template)
...
1. Source page: https://backstage.io/docs/features/software-templates/adding-templates
