---
type: Web Page
title: Software Template Configuration | Backstage Software Catalog and Developer
  Platform
...
Software templates can define *publish* actions, such as `publish:github`, to
...
In the new frontend system the templates page is built from extensions, so customisations are configured rather than passed as JSX props.
...
1. Source page: https://backstage.io/docs/features/software-templates/configuration
