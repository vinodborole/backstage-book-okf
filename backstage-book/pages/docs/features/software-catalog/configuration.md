...
[Stitching](/docs/features/software-catalog/life-of-an-entity#stitching) finalizes entities asynchronously via a worker queue. You can tune the following parameters under `catalog.stitchingStrategy`:
...
```
1. Add the configuration to your `app-config.yaml` :
...
1. Source page: https://backstage.io/docs/features/software-catalog/configuration
