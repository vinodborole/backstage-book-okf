---
type: Web Page
title: Well-known Annotations on Catalog Entities | Backstage Software Catalog and
  Developer Platform
description: Documentation that lists a number of well known Annotations, that have
...
*not* lead to the other `Component` entity to be removed from the catalog (for
...
1. Source page: https://backstage.io/docs/features/software-catalog/well-known-annotations
