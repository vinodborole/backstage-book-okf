---
type: Web Page
title: Catalog Customization | Backstage Software Catalog and Developer Platform
description: How to add custom filters or interface elements to the Backstage software
  catalog
resource: https://backstage.io/docs/features/software-catalog/catalog-customization
...
read the [old frontend system version of this guide](/docs/features/software-catalog/catalog-customization--old)
instead.
...
For example, to customize the catalog index page with custom columns or actions, you can override the page extension using a frontend module:
...
available, see the [extension overrides](/docs/frontend-system/architecture/extension-overrides) documentation.
...
1. Source page: https://backstage.io/docs/features/software-catalog/catalog-customization
