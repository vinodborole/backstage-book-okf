---
type: Web Page
title: Entity Presentation | Backstage Software Catalog and Developer Platform
description: How to display entity names and control how entities are represented
  in the Backstage interface
resource: https://backstage.io/docs/features/software-catalog/entity-presentation
timestamp: '2026-08-03T09:44:12.848210+00:00'
---

# Entity Presentation

The *Entity Presentation API* controls how catalog entities are displayed
...
1. Source page: https://backstage.io/docs/features/software-catalog/entity-presentation
