---
type: Web Page
title: Descriptor Format of Catalog Entities | Backstage Software Catalog and Developer
  Platform
description: Documentation on Descriptor Format of Catalog Entities which describes
  the default data shape and semantics of catalog entities
...
*envelope*, defining the overall structure of all kinds of entity. Likewise,
...
[ADR005](/docs/architecture-decisions/adrs-adr005) describes
...
understand their semantics. See [Extending the model](/docs/features/software-catalog/extending-the-model)
...
The ID of a namespace that the entity belongs to. This field is optional, and has no special semantics apart from bounding the name uniqueness constraint if specified.
...
for simplicity until it's necessary to use supplemental ones. See [the references article](/docs/features/software-catalog/references) for more information.
...
Note that `uid` values are *not* to be seen as stable, and should *not* be used
...
always use [string-form entity reference](/docs/features/software-catalog/references#string-references)
instead.
...
the code. [Entity references](/docs/features/software-catalog/references) still always make use of the `name`
...
There is a list of [well-known annotations](/docs/features/software-catalog/well-known-annotations), but
...
[well-known relations section](/docs/features/software-catalog/well-known-relations). Relations are commonly
...
| Field | Type | Description | 
|---|---|---|
| `targetRef` | String | A full [entity reference](/docs/features/software-catalog/references) to the other end of the relation. | 
...
See the [well-known relations section](/docs/features/software-catalog/well-known-relations) for a list of
...
[well-known statuses section](/docs/features/software-catalog/well-known-statuses).
...
See the [well-known statuses section](/docs/features/software-catalog/well-known-statuses) for a list of
...
An [entity reference](/docs/features/software-catalog/references#string-references) to the owner of the
...
| [`kind`](#apiversion-and-kind-required) | Default [`namespace`](#namespace-optional) | Generated [relation](/docs/features/software-catalog/well-known-relations) type | 
|---|---|---|
| [`Group`](#kind-group) (default),[`User`](#kind-user) | Same as this entity, typically `default` | [`ownedBy`, and reverse `ownerOf`](/docs/features/software-catalog/well-known-relations#ownedby-and-ownerof) | 

### `spec.system` [optional]

An [entity reference](/docs/features/software-catalog/references#string-references) to the system that the
component belongs to, e.g. `artist-engagement-portal`. This field is optional.

| [`kind`](#apiversion-and-kind-required) | Default [`namespace`](#namespace-optional) | Generated [relation](/docs/features/software-catalog/well-known-relations) type | 
|---|---|---|
| [`System`](#kind-system) (default) | Same as this entity, typically `default` | [`partOf`, and reverse `hasPart`](/docs/features/software-catalog/well-known-relations#partof-and-haspart) | 

### `spec.subcomponentOf` [optional]

An [entity reference](/docs/features/software-catalog/references#string-references) to another component of
which the component is a part, e.g. `spotify-ios-app`. This field is optional.

| [`kind`](#apiversion-and-kind-required) | Default [`namespace`](#namespace-optional) | Generated [relation](/docs/features/software-catalog/well-known-relations) type | 
|---|---|---|
| [`Component`](#kind-component) (default) | Same as this entity, typically `default` | [`partOf`, and reverse `hasPart`](/docs/features/software-catalog/well-known-relations#partof-and-haspart) | 

### `spec.providesApis` [optional]

An array of [entity references](/docs/features/software-catalog/references#string-references) to the APIs
that are provided by the component, e.g. `artist-api`. This field is optional.

| [`kind`](#apiversion-and-kind-required) | Default [`namespace`](#namespace-optional) | Generated [relation](/docs/features/software-catalog/well-known-relations) type | 
|---|---|---|
| [`API`](#kind-api) (default) | Same as this entity, typically `default` | [`providesApi`, and reverse `apiProvidedBy`](/docs/features/software-catalog/well-known-relations#providesapi-and-apiprovidedby) | 
...
| [`kind`](#apiversion-and-kind-required) | Default [`namespace`](#namespace-optional) | Generated [relation](/docs/features/software-catalog/well-known-relations) type | 
|---|---|---|
| [`API`](#kind-api) (default) | Same as this entity, typically `default` | [`consumesApi`, and reverse `apiConsumedBy`](/docs/features/software-catalog/well-known-relations#consumesapi-and-apiconsumedby) | 

### `spec.dependsOn` [optional]

An array of [entity references](/docs/features/software-catalog/references#string-references) to the
components and resources that the component depends on, e.g. `artists-db`. This
field is optional.

| [`kind`](#apiversion-and-kind-required) | Default [`namespace`](#namespace-optional) | Generated [relation](/docs/features/software-catalog/well-known-relations) type | 
|---|---|---|
| [`Component`](#kind-component) | Same as this entity, typically `default` | [`dependsOn`, and reverse `dependencyOf`](/docs/features/software-catalog/well-known-relations#dependson-and-dependencyof) | 
| [`Resource`](#kind-resource) | Same as this entity, typically `default` | [`dependsOn`, and reverse `dependencyOf`](/docs/features/software-catalog/well-known-relations#dependson-and-dependencyof) | 
...
| [`kind`](#apiversion-and-kind-required) | Default [`namespace`](#namespace-optional) | Generated [relation](/docs/features/software-catalog/well-known-relations) type | 
|---|---|---|
| [`Component`](#kind-component) | Same as this entity, typically `default` | [`dependencyOf`, and reverse `dependsOn`](/docs/features/software-catalog/well-known-relations#dependson-and-dependencyof) | 
| [`Resource`](#kind-resource) | Same as this entity, typically `default` | [`dependencyOf`, and reverse `dependsOn`](/docs/features/software-catalog/well-known-relations#dependson-and-dependencyof) | 
...
[here](/docs/features/software-templates/writing-templates)
...
- `asyncapi` - An API definition based on the[AsyncAPI](https://www.asyncapi.com/docs/reference/specification/latest) version 2 or version 3 spec.
...
| [`kind`](#apiversion-and-kind-required) | Default [`namespace`](#namespace-optional) | Generated [relation](/docs/features/software-catalog/well-known-relations) type | 
|---|---|---|
| [`Group`](#kind-group) (default) | Same as this entity, typically `default` | [`childOf`, and reverse `parentOf`](/docs/features/software-catalog/well-known-relations#parentof-and-childof) | 
...
| [`kind`](#apiversion-and-kind-required) | Default [`namespace`](#namespace-optional) | Generated [relation](/docs/features/software-catalog/well-known-relations) type | 
|---|---|---|
| [`Group`](#kind-group) (default) | Same as this entity, typically `default` | [`parentOf`, and reverse `childOf`](/docs/features/software-catalog/well-known-relations#parentof-and-childof) | 
...
| [`kind`](#apiversion-and-kind-required) | Default [`namespace`](#namespace-optional) | Generated [relation](/docs/features/software-catalog/well-known-relations) type | 
|---|---|---|
| [`User`](#kind-user) (default) | Same as this entity, typically `default` | [`hasMember`, and reverse `memberOf`](/docs/features/software-catalog/well-known-relations#memberof-and-hasmember) | 
...
| [`kind`](#apiversion-and-kind-required) | Default [`namespace`](#namespace-optional) | Generated [relation](/docs/features/software-catalog/well-known-relations) type | 
|---|---|---|
| [`Group`](#kind-group) (default) | Same as this entity, typically `default` | [`memberOf`, and reverse `hasMember`](/docs/features/software-catalog/well-known-relations#memberof-and-hasmember) | 
...
An [entity reference](/docs/features/software-catalog/references#string-references) to the domain that the
system belongs to, e.g. `artists`. This field is optional.

| [`kind`](#apiversion-and-kind-required) | Default [`namespace`](#namespace-optional) | Generated [relation](/docs/features/software-catalog/well-known-relations) type | 
|---|---|---|
| [`Domain`](#kind-domain) (default) | Same as this entity, typically `default` | [`partOf`, and reverse `hasPart`](/docs/features/software-catalog/well-known-relations#partof-and-haspart) | 
...
An [entity reference](/docs/features/software-catalog/references#string-references) to another domain of
...
The type of domain. There is currently no enforced set of values for this field, so it is left up to the adopting organization to choose a nomenclature that matches their catalog hierarchy. This field is optional.
...
1. Source page: https://backstage.io/docs/features/software-catalog/descriptor-format
