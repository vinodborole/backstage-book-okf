---
type: Web Page
title: Audit Events | Backstage Software Catalog and Developer Platform
description: Tracking access to your Software Catalog.
resource: https://backstage.io/docs/features/software-catalog/audit-events
...
- 
**`entity-mutate`** : Modifies entities.Filter on `actionType` .
...
- 
**`location-fetch`** : Retrieves locations.Filter on `actionType` .
...
1. Source page: https://backstage.io/docs/features/software-catalog/audit-events
