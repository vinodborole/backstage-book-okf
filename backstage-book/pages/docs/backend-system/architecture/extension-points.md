---
type: Web Page
title: Backend Plugin Extension Points | Backstage Software Catalog and Developer
  Platform
...
1. Source page: https://backstage.io/docs/backend-system/architecture/extension-points
