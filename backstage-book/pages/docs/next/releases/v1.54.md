---
type: Web Page
title: v1.54.0 | Backstage Software Catalog and Developer Platform
description: Backstage Release v1.54.0
resource: https://backstage.io/docs/next/releases/v1.54.0
...
Fixed `Table` not filling the container width in Firefox when `TableRoot` is used directly inside `ResizableTableContainer`. Contributed by [@robingileborg](https://github.com/robingileborg) in [#34755](https://github.com/backstage/backstage/pull/34755).

Check the [BUI Changelog](https://ui.backstage.io/changelog) for more details.

### Additional fixes and improvements

- Fixed config-driven route redirects in the new frontend system so they preserve the query string and fragment from the original URL. Contributed by [@niklasR](https://github.com/niklasR) in[#35002](https://github.com/backstage/backstage/pull/35002) .
...
- Fixed the About card field labels so theme typography overrides no longer change the intended label size. Contributed by [@meganide](https://github.com/meganide) in[#35076](https://github.com/backstage/backstage/pull/35076) .
- Fixed the `DependencyGraph` component so nodes no longer briefly overlap before the initial layout settles.
- Fixed `EntityOwnerPicker` in`owners-only` mode to display human-readable entity titles and keep large owner lists responsive through virtualization. Contributed by[@Parsifal-M](https://github.com/Parsifal-M) in[#34873](https://github.com/backstage/backstage/pull/34873) .
...
- Fixed the Azure DevOps URL reader so abort signals are forwarded to the commits API request. Contributed by [@mohamedaminehamdi](https://github.com/mohamedaminehamdi) in[#34734](https://github.com/backstage/backstage/pull/34734) .
- Fixed OAuth start requests with malformed origins returning a 500 instead of a 400.
- Fixed the built-in CLI client being rejected when `allowedClientIdPatterns` is configured for Client ID Metadata Documents. Contributed by[@arogozin](https://github.com/arogozin) in[#34990](https://github.com/backstage/backstage/pull/34990) .
...
- Fixed notification recipient resolution for cyclic group relationships. Contributed by [@marttimourujarvi](https://github.com/marttimourujarvi) in[#34618](https://github.com/backstage/backstage/pull/34618) .
- Added support for routing Slack notifications to a specific channel via `payload.metadata.slackChannel` . Contributed by[@sspadotto](https://github.com/sspadotto) in[#34968](https://github.com/backstage/backstage/pull/34968) .
- Added a `kubernetes.clusterLocatorContinueOnError` configuration option so a failing cluster locator can be skipped while clusters from other locators are still returned. Contributed by[@alde](https://github.com/alde) in[#34861](https://github.com/backstage/backstage/pull/34861) .
...
- Made the `description` parameter optional in the`publish:gerrit` scaffolder action. Contributed by[@tcardonne](https://github.com/tcardonne) in[#34453](https://github.com/backstage/backstage/pull/34453) .
...
Big shoutout to all 36 of you amazing folks who chipped in on this release: [@04kash](https://github.com/04kash), [@AntonioEreiz](https://github.com/AntonioEreiz), [@Believe-SA](https://github.com/Believe-SA), [@JasonColapietro](https://github.com/JasonColapietro), [@Kartikupadhyay44](https://github.com/Kartikupadhyay44), [@KrishnaParihar1](https://github.com/KrishnaParihar1), [@Naga15](https://github.com/Naga15), [@Nikshaan](https://github.com/Nikshaan), [@NithinU2802](https://github.com/NithinU2802), [@Parsifal-M](https://github.com/Parsifal-M), [@alde](https://github.com/alde), [@arogozin](https://github.com/arogozin), [@baraka-akeyless](https://github.com/baraka-akeyless), [@deejay1](https://github.com/deejay1), [@djamaile](https://github.com/djamaile), [@dotboris](https://github.com/dotboris), [@drodil](https://github.com/drodil), [@gaelgoth](https://github.com/gaelgoth), [@hudsonb](https://github.com/hudsonb), [@jozsefurak-seon](https://github.com/jozsefurak-seon), [@karthikjeeyar](https://github.com/karthikjeeyar), [@kz-masa](https://github.com/kz-masa), [@marttimourujarvi](https://github.com/marttimourujarvi), [@meganide](https://github.com/meganide), [@mohamedaminehamdi](https://github.com/mohamedaminehamdi), [@mylonasg88](https://github.com/mylonasg88), [@neoreddog](https://github.com/neoreddog), [@nickwtan](https://github.com/nickwtan), [@niklasR](https://github.com/niklasR), [@piyushtripathi9424](https://github.com/piyushtripathi9424), [@robingileborg](https://github.com/robingileborg), [@sebastian-danielsson](https://github.com/sebastian-danielsson), [@sspadotto](https://github.com/sspadotto), [@tcardonne](https://github.com/tcardonne), [@thepetk](https://github.com/thepetk), [@vetom](https://github.com/vetom)
...
1. Source page: https://backstage.io/docs/next/releases/v1.54.0
