...
description: TechDocs is Spotify’s homegrown docs-like-code solution built directly
  into Backstage
resource: https://backstage.io/docs/next/features/techdocs
...
- Take advantage of the [TechDocs Addon Framework](/docs/next/features/techdocs/addons)to add features on top of the base docs-like-code experience.
...
See [TechDocs Architecture](/docs/next/features/techdocs/architecture) to get an overview of where the below providers are used.
...
- [Instructions for upgrading from Alpha to Beta](/docs/next/features/techdocs/how-to-guides#how-to-migrate-from-techdocs-alpha-to-beta)
...
1. Source page: https://backstage.io/docs/next/features/techdocs
