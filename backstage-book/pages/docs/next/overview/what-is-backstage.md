...
description: Backstage is an open source framework for building developer portals.
  ...
  and infrastructure
resource: https://backstage.io/docs/next/overview/what-is-backstage
...
- 
[Backstage Software Catalog](/docs/next/features/software-catalog/) for
managing all your software (microservices, libraries, data pipelines,
websites, ML models, etc.)
- 
[Backstage Software Templates](/docs/next/features/software-templates/) for
quickly spinning up new projects and standardizing your tooling with your
organization’s best practices
- 
[Backstage TechDocs](/docs/next/features/techdocs/) for making it easy to
...
1. Source page: https://backstage.io/docs/next/overview/what-is-backstage
