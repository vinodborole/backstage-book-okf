---
type: Web Page
title: 'ADR011: Plugin Package Structure | Backstage Software Catalog and Developer
  Platform'
...
- While the new location of `packages/catalog-model` should be`plugins/catalog-common` we might want to do an exception here, as it's a very
central package.
...
1. Source page: https://backstage.io/docs/architecture-decisions/adrs-adr011
