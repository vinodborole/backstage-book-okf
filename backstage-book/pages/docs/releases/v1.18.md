---
type: Web Page
title: v1.18.0 | Backstage Software Catalog and Developer Platform
description: Backstage Release v1.18.0
resource: https://backstage.io/docs/releases/v1.18.0
...
1. Source page: https://backstage.io/docs/releases/v1.18.0
