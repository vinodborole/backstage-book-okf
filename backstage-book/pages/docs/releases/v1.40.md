---
type: Web Page
title: v1.40.0 | Backstage Software Catalog and Developer Platform
description: Backstage Release v1.40.0
resource: https://backstage.io/docs/releases/v1.40.0
...
As always you can head over the latest changelogs for [ @backstage/plugin-scaffolder-backend](https://github.com/backstage/backstage/blob/master/plugins/scaffolder-backend/CHANGELOG.md) and 

[for more detailed information.](https://github.com/backstage/backstage/blob/master/plugins/scaffolder-node/CHANGELOG.md)

`@backstage/plugin-scaffolder-node`There’s also a number of new deprecation for types which are currently exported from `plugin-scaffolder-node`. We’re going to be looking at re-working the Scaffolder architecture in the future, so we’re going to be removing these types in a future version to iterate on the new API surfaces. Stay tuned for more updates!
...
1. Source page: https://backstage.io/docs/releases/v1.40.0
