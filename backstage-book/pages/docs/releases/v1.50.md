---
type: Web Page
title: v1.50.0 | Backstage Software Catalog and Developer Platform
description: Backstage Release v1.50.0
resource: https://backstage.io/docs/releases/v1.50.0
...
- **Header tab**: Tab- `href`resolution- `href`values are now resolved through the router context instead of being passed raw. Relative- `href`values are resolved against the current route, and absolute values may be affected by the router's- `basename`configuration.
...
1. Source page: https://backstage.io/docs/releases/v1.50.0
