---
type: Web Page
title: v1.28.0 | Backstage Software Catalog and Developer Platform
description: Backstage Release v1.28.0
resource: https://backstage.io/docs/releases/v1.28.0
...
- Removed deprecated code from when casing was changed from `GitHub`to`Github`nearly two years ago. The following items have been removed:- `getGitHubFileFetchUrl`(use- `getGithubFileFetchUrl`instead)
...
1. Source page: https://backstage.io/docs/releases/v1.28.0
