---
type: Web Page
title: v1.14.0 | Backstage Software Catalog and Developer Platform
description: Backstage Release v1.14.0
resource: https://backstage.io/docs/releases/v1.14.0
...
A [security flaw in the  vm2 package](https://cve.mitre.org/cgi-bin/cvename.cgi?name=CVE-2023-32314) used by the Scaffolder plugin was patched by our automated security processes in 

[#17810](https://github.com/backstage/backstage/pull/17810). The fixed version of
...
1. Source page: https://backstage.io/docs/releases/v1.14.0
