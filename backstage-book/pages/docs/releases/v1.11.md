...
There are a few smaller tweaks as well, that you can read about in the [ @backstage/backend-app-api](https://github.com/backstage/backstage/blob/master/packages/backend-app-api/CHANGELOG.md) and 

[changelogs.](https://github.com/backstage/backstage/blob/master/packages/backend-plugin-api/CHANGELOG.md)

`@backstage/backend-plugin-api`### New package: `@backstage/eslint-plugin`
