---
type: Web Page
title: v1.15.0 | Backstage Software Catalog and Developer Platform
description: Backstage Release v1.15.0
resource: https://backstage.io/docs/releases/v1.15.0
...
your operating system of choice. The `isolated-vm` repo has some further information about the
...
1. Source page: https://backstage.io/docs/releases/v1.15.0
