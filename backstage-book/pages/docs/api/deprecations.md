...
```
Provider specific factory implementations, copy the code you need into the factory method depending on which API ref you previously used.
...
1. Source page: https://backstage.io/docs/api/deprecations
